...
var postContentSelector = function name(el) {
  ...
  if (el('div.post-bodycopy > div[style="text-align: justify;"], div.post-bodycopy > div[style="text-align: justify"]').text() != "") {
    return el('div.post-bodycopy > div[style="text-align: justify;"], div.post-bodycopy > div[style="text-align: justify"]').text().trim();
  }
